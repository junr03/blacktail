{
  ...
  inputs = {
    ...
    gallatin = {
      url = "github:junr03/gallatin?rev=1b521b177aca6e88bf25ed49da6bfeb3588589bf";
      flake = false;
    };
    gallatinRunners.url = "github:junr03/gallatin?dir=runners&rev=1b521b177aca6e88bf25ed49da6bfeb3588589bf";
  };
  outputs =
    {
      darwin,
